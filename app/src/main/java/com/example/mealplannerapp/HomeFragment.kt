...
//                binding.recentlyUsedRecyclerView.layoutManager =
//                    LinearLayoutManager(requireContext(), LinearLayoutManager.HORIZONTAL, false)
//                // Initialize the adapter with the mapped list.
//                binding.recentlyUsedRecyclerView.adapter =
...
class HomeFragment : BaseFragment<FragmentHomeBinding>(FragmentHomeBinding::inflate) {
    ...
    private val recentRecipeList = mutableListOf<RecipeSearch.RecipeDisplayInfo>()
    ...
    private fun setupRecyclerView() {
        ...
        recipeAdapter = RecipeAdapter(recentRecipeList, activity)
    ...
    private fun loadRecentlySavedRecipes() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                ...
                recentRecipeList.addAll(displayList)
